...
output "sec_group"{
    value = [
        ...
        "${aws_security_group.jenkins.vpc_id}",
        "${aws_security_group.jenkins.egress}"
    ]
}


output "vpc_cidr_block "{
    value = "${aws_vpc.jenkins.cidr_block}"
}
...
output "allocation_ip "{
    value = "${aws_eip.jenkins-nat-gw.id}"
}
